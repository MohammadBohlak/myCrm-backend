...
handler.get(async (req, res)=>{
    try {
        const customers = await _models_User__WEBPACK_IMPORTED_MODULE_2__/* ["default"].find */ .Z.find({
            role: "customer",
            isDeleted: false
...
var __webpack_exports__ = __webpack_require__.X(0, [762,76], () => (__webpack_exec__(5495)));
