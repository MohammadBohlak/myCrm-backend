...
handler.delete(async (req, res)=>{
    try {
        const deletedCustomer = await _models_Customer__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findByIdAndDelete */ .Z.findByIdAndDelete(req.query.id);
        if (!deletedCustomer) {
...
var __webpack_exports__ = __webpack_require__.X(0, [762,414,285,809], () => (__webpack_exec__(5227)));
