...
handler.put(async (req, res)=>{
    try {
        ...
        const restoredProduct = await _models_Product__WEBPACK_IMPORTED_MODULE_1__/* ["default"].findByIdAndUpdate */ .Z.findByIdAndUpdate(req.query.id, {
            isDeleted: false,
            $unset: {
                deletedAt: 1
            }
...
var __webpack_exports__ = __webpack_require__.X(0, [762], () => (__webpack_exec__(7844)));
